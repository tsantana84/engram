"use strict";var Nt=Object.create;var $=Object.defineProperty;var Rt=Object.getOwnPropertyDescriptor;var It=Object.getOwnPropertyNames;var Ct=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var Mt=(r,e)=>{for(var t in e)$(r,t,{get:e[t],enumerable:!0})},Ee=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of It(e))!Lt.call(r,n)&&n!==t&&$(r,n,{get:()=>e[n],enumerable:!(s=Rt(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?Nt(Ct(r)):{},Ee(e||!r||!r.__esModule?$(t,"default",{value:r,enumerable:!0}):t,r)),yt=r=>Ee($({},"__esModule",{value:!0}),r);var Jt={};Mt(Jt,{generateContext:()=>ce});module.exports=yt(Jt);var bt=y(require("path"),1),At=require("os"),ht=require("fs");var he=require("bun:sqlite"),Oe=require("child_process");var f=require("path"),Q=require("os"),w=require("fs");var Te=require("url");var C=require("fs"),D=require("path"),le=require("os"),K=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(K||{}),pe=(0,D.join)((0,le.homedir)(),".engram"),J=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,D.join)(pe,"logs");(0,C.existsSync)(e)||(0,C.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,D.join)(e,`engram-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,D.join)(pe,"settings.json");if((0,C.existsSync)(e)){let t=(0,C.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=K[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
