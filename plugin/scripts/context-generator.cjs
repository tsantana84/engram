"use strict";var Ot=Object.create;var w=Object.defineProperty;var Rt=Object.getOwnPropertyDescriptor;var It=Object.getOwnPropertyNames;var Lt=Object.getPrototypeOf,Ct=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},me=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of It(e))!Ct.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Rt(e,n))||s.enumerable});return r};var M=(r,e,t)=>(t=r!=null?Ot(Lt(r)):{},me(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),Mt=r=>me(w({},"__esModule",{value:!0}),r);var Jt={};yt(Jt,{generateContext:()=>ce});module.exports=Mt(Jt);var bt=M(require("path"),1),ht=require("os"),At=require("fs");var Ae=require("bun:sqlite"),Ne=require("child_process");var f=require("path"),Q=require("os"),$=require("fs");var Te=require("url");var L=require("fs"),D=require("path"),le=require("os"),K=(i=>(i[i.DEBUG=0]="DEBUG",i[i.INFO=1]="INFO",i[i.WARN=2]="WARN",i[i.ERROR=3]="ERROR",i[i.SILENT=4]="SILENT",i))(K||{}),pe=(0,D.join)((0,le.homedir)(),".engram"),J=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;sinks=[];constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,D.join)(pe,"logs");(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,D.join)(e,`engram-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,D.join)(pe,"settings.json");if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=K[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),i=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${i}:${o}:${a}.${d}`}log(e,t,s,n,i){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),a=K[e].padEnd(5),d=t.padEnd(6),u="";n?.correlationId?u=`[${n.correlationId}] `:n?.sessionId&&(u=`[session-${n.sessionId}] `);let E="";i!=null&&(i instanceof Error?E=this.getLevel()===0?`
${i.message}
${i.stack}`:` ${i.message}`:this.getLevel()===0&&typeof i=="object"?E=`
`+JSON.stringify(i,null,2):E=" "+this.formatData(i));let p="";if(n){let{sessionId:g,memorySessionId:b,correlationId:O,...m}=n;Object.keys(m).length>0&&(p=` {${Object.entries(m).map(([T,S])=>`${T}=${S}`).join(", ")}}`)}let l=`[${o}] [${a}] [${d}] ${u}${s}${p}${E}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,l+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),E=u?`${u[1].split("/").pop()}:${u[2]}`:"unknown",p={...s,location:E};return this.warn(e,`[HAPPY-PATH] ${t}`,p,n),i}},c=new J;var xt={};function Dt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Te.fileURLToPath)(xt.url))}var vt=Dt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,Q.homedir)(),".engram"),e=(0,f.join)(r,"settings.json");try{if((0,$.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var R=Ut(),C=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,Q.homedir)(),".claude"),ts=(0,f.join)(C,"plugins","marketplaces","thedotmack"),ss=(0,f.join)(R,"archives"),rs=(0,f.join)(R,"logs"),ns=(0,f.join)(R,"trash"),is=(0,f.join)(R,"backups"),os=(0,f.join)(R,"modes"),as=(0,f.join)(R,"settings.json"),ge=(0,f.join)(R,"claude-mem.db"),ds=(0,f.join)(R,"vector-db"),_s=(0,f.join)(R,"observer-sessions"),us=(0,f.join)(C,"settings.json"),cs=(0,f.join)(C,"commands"),Es=(0,f.join)(C,"CLAUDE.md");function fe(r){(0,$.mkdirSync)(r,{recursive:!0})}function Se(){return(0,f.join)(vt,"..")}var be=require("crypto");var kt=3e4;function P(r,e,t){return(0,be.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function X(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function Ft(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return h;let e=Ft(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function he(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),i=e.indexOf(s);return n!==-1||i!==-1?n===-1?1:i===-1?-1:n-i:t.localeCompare(s)})}function wt(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var H=class{db;syncQueue=null;setSyncQueue(e){this.syncQueue=e}constructor(e=ge){e!==":memory:"&&fe(R),this.db=new Ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.createSyncQueueTable(),this.addProvenanceColumns(),this.addExtractionStatusColumns(),this.widenSyncQueueForLearnings(),this.addLastErrorColumn(),this.createSessionBriefingsTable(),this.createGraphEdgesTable(),this.createTickLogTable()}initializeSchema(){this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),c.debug("DB","pending_messages table created successfully")}renameSessionIdColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(17))return;c.debug("DB","Checking session ID columns for semantic clarity rename");let t=0,s=(n,i,o)=>{let a=this.db.query(`PRAGMA table_info(${n})`).all(),d=a.some(E=>E.name===i);return a.some(E=>E.name===o)?!1:d?(this.db.run(`ALTER TABLE ${n} RENAME COLUMN ${i} TO ${o}`),c.debug("DB",`Renamed ${n}.${i} to ${o}`),!0):(c.warn("DB",`Column ${i} not found in ${n}, skipping rename`),!1)};s("sdk_sessions","claude_session_id","content_session_id")&&t++,s("sdk_sessions","sdk_session_id","memory_session_id")&&t++,s("pending_messages","claude_session_id","content_session_id")&&t++,s("observations","sdk_session_id","memory_session_id")&&t++,s("session_summaries","sdk_session_id","memory_session_id")&&t++,s("user_prompts","claude_session_id","content_session_id")&&t++,this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(17,new Date().toISOString()),t>0?c.debug("DB",`Successfully renamed ${t} session ID columns`):c.debug("DB","No session ID column renames needed (already up to date)")}repairSessionIdColumnRename(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(19)||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(19,new Date().toISOString())}addFailedAtEpochColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(20))return;this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="failed_at_epoch")||(this.db.run("ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"),c.debug("DB","Added failed_at_epoch column to pending_messages table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(20,new Date().toISOString())}addOnUpdateCascadeToForeignKeys(){if(!this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(21)){c.debug("DB","Adding ON UPDATE CASCADE to FK constraints on observations and session_summaries"),this.db.run("PRAGMA foreign_keys = OFF"),this.db.run("BEGIN TRANSACTION");try{this.db.run("DROP TRIGGER IF EXISTS observations_ai"),this.db.run("DROP TRIGGER IF EXISTS observations_ad"),this.db.run("DROP TRIGGER IF EXISTS observations_au"),this.db.run("DROP TABLE IF EXISTS observations_new"),this.db.run(`
      ...
      `),this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='session_summaries_fts'").all().length>0&&this.db.run(`
          ...
          CREATE TRIGGER IF NOT EXISTS session_summaries_au AFTER UPDATE ON session_summaries BEGIN
            ...
            VALUES (new.id, new.request, new.investigated, new.learned, new.completed, new.next_steps, new.notes);
          END;
        `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(21,new Date().toISOString()),this.db.run("COMMIT"),this.db.run("PRAGMA foreign_keys = ON"),c.debug("DB","Successfully added ON UPDATE CASCADE to FK constraints")}catch(t){throw this.db.run("ROLLBACK"),this.db.run("PRAGMA foreign_keys = ON"),t}}}addObservationContentHashColumn(){if(this.db.query("PRAGMA table_info(observations)").all().some(s=>s.name==="content_hash")){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(22,new Date().toISOString());return}this.db.run("ALTER TABLE observations ADD COLUMN content_hash TEXT"),this.db.run("UPDATE observations SET content_hash = substr(hex(randomblob(8)), 1, 16) WHERE content_hash IS NULL"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observations_content_hash ON observations(content_hash, created_at_epoch)"),c.debug("DB","Added content_hash column to observations table with backfill and index"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(22,new Date().toISOString())}addSessionCustomTitleColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(23))return;this.db.query("PRAGMA table_info(sdk_sessions)").all().some(n=>n.name==="custom_title")||(this.db.run("ALTER TABLE sdk_sessions ADD COLUMN custom_title TEXT"),c.debug("DB","Added custom_title column to sdk_sessions table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(23,new Date().toISOString())}addSessionPlatformSourceColumn(){let t=this.db.query("PRAGMA table_info(sdk_sessions)").all().some(o=>o.name==="platform_source"),n=this.db.query("PRAGMA index_list(sdk_sessions)").all().some(o=>o.name==="idx_sdk_sessions_platform_source");this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(24)&&t&&n||(t||(this.db.run(`ALTER TABLE sdk_sessions ADD COLUMN platform_source TEXT NOT NULL DEFAULT '${h}'`),c.debug("DB","Added platform_source column to sdk_sessions table")),this.db.run(`
      UPDATE sdk_sessions
    ...
    `).all(e)}getSessionObservations(e){let t=this.getSessionById(e);return!t||!t.memory_session_id?[]:this.db.prepare("SELECT id, title, narrative FROM observations WHERE memory_session_id = ? ORDER BY created_at_epoch ASC").all(t.memory_session_id)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:i,type:o,concepts:a,files:d}=t,u=s==="date_asc"?"ASC":"DESC",E=n?`LIMIT ${n}`:"",p=e.map(()=>"?").join(","),l=[...e],g=[];if(i&&(g.push("project = ?"),l.push(i)),o)if(Array.isArray(o)){let m=o.map(()=>"?").join(",");g.push(`type IN (${m})`),l.push(...o)}else g.push("type = ?"),l.push(o);if(a){let m=Array.isArray(a)?a:[a],A=m.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");l.push(...m),g.push(`(${A.join(" OR ")})`)}if(d){let m=Array.isArray(d)?d:[d],A=m.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");m.forEach(T=>{l.push(`%${T}%`,`%${T}%`)}),g.push(`(${A.join(" OR ")})`)}let b=g.length>0?`WHERE id IN (${p}) AND ${g.join(" AND ")}`:`WHERE id IN (${p})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,i){let o=new Date,a=o.getTime(),d=wt(n,i),u=d.platformSource??h,E=this.db.prepare(`
    ...
    `).get(e);if(E){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let l=E.platform_source?.trim()?y(E.platform_source):void 0;if(!l)this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,u,s,d.customTitle||null,o.toISOString(),a),this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e).id}saveUserPrompt(e,t,s){let n=new Date,i=n.getTime();return this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),i).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,i=0,o,a){let d=o??Date.now(),u=new Date(d).toISOString(),E=P(e,s.title,s.narrative),p=X(this.db,E,d);if(p)return{id:p.id,createdAtEpoch:p.created_at_epoch};let l=null;try{let m=(0,Ne.spawnSync)("git",["rev-parse","--abbrev-ref","HEAD"],{encoding:"utf8",timeout:2e3});m.status===0&&!m.error&&(l=m.stdout.trim()||null)}catch{}let b=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
       generated_by_model, git_branch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,i,E,u,d,a||null,l),O=Number(b.lastInsertRowid);return this.syncQueue?.enqueue("observation",O),{id:O,createdAtEpoch:d}}invalidateObservation(e,t){let s=Date.now();this.db.prepare(`
      UPDATE observations
    ...
    `).run(e)}storeSummary(e,t,s,n,i=0,o){let a=o??Date.now(),d=new Date(a).toISOString(),E=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,i,d,a),p=Number(E.lastInsertRowid);return this.syncQueue?.enqueue("summary",p),{id:p,createdAtEpoch:a}}storeObservations(e,t,s,n,i,o=0,a,d){let u=a??Date.now(),E=new Date(u).toISOString(),l=this.db.transaction(()=>{let g=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let m of s){let A=P(e,m.title,m.narrative),T=X(this.db,A,u);if(T){g.push(T.id);continue}let S=b.run(e,t,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),i||null,o,A,E,u,d||null);g.push(Number(S.lastInsertRowid))}let O=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,i||null,o,E,u);O=Number(A.lastInsertRowid)}return{observationIds:g,summaryId:O,createdAtEpoch:u}})();for(let g of l.observationIds)this.syncQueue?.enqueue("observation",g);return l.summaryId!==null&&this.syncQueue?.enqueue("summary",l.summaryId),l}storeObservationsAndMarkComplete(e,t,s,n,i,o,a,d=0,u,E){let p=u??Date.now(),l=new Date(p).toISOString();return this.db.transaction(()=>{let b=[],O=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let S=P(e,T.title,T.narrative),Ee=X(this.db,S,p);if(Ee){b.push(Ee.id);continue}let Nt=O.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),a||null,d,S,l,p,E||null);b.push(Number(Nt.lastInsertRowid))}let m;if(n){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,l,p);m=Number(S.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(p,i),{observationIds:b,summaryId:m,createdAtEpoch:p}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:i}=t,o=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),u=[...e],E=i?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return i&&u.push(i),this.db.prepare(`
      SELECT * FROM session_summaries
      ${E}
      ORDER BY created_at_epoch ${o}
      ${a}
    `).all(...u)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:i}=t,o=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),u=[...e],E=i?"AND s.project = ?":"";return i&&u.push(i),this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
    `).all(...u)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,i){let o=i?"AND project = ?":"",a=i?[i]:[],d,u;if(e!==null){let m=`
      ...
      `,A=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let T=this.db.prepare(m).all(e,...a,s+1),S=this.db.prepare(A).all(e,...a,n+1);if(T.length===0&&S.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,u=S.length>0?S[S.length-1].created_at_epoch:t}catch(T){return c.error("DB","Error getting boundary observations",void 0,{error:T,project:i}),{observations:[],sessions:[],prompts:[]}}}else{let m=`
      ...
      `,A=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let T=this.db.prepare(m).all(t,...a,s),S=this.db.prepare(A).all(t,...a,n+1);if(T.length===0&&S.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,u=S.length>0?S[S.length-1].created_at_epoch:t}catch(T){return c.error("DB","Error getting boundary timestamps",void 0,{error:T,project:i}),{observations:[],sessions:[],prompts:[]}}}let E=`
      SELECT *
      FROM observations
    ...
    `).get(e)||null}getOrCreateManualSession(e){let t=`manual-${e}`,s=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(t))return t;let i=new Date;return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(t,s,e,h,i.toISOString(),i.getTime()),c.info("SESSION","Created manual session",{memorySessionId:t,project:e}),t}close(){this.db.close()}importSdkSession(e){let t=this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e.content_session_id);return t?{imported:!1,id:t.id}:{imported:!0,id:this.db.prepare(`
      INSERT INTO sdk_sessions (
    ...
    `).run(e.content_session_id,e.prompt_number,e.prompt_text,e.created_at,e.created_at_epoch).lastInsertRowid}}addLastErrorColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31))return;this.db.prepare("PRAGMA table_info(sync_queue)").all().some(s=>s.name==="last_error")||this.db.run("ALTER TABLE sync_queue ADD COLUMN last_error TEXT"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),c.debug("DB","Migration 31 applied: last_error column on sync_queue")}createSessionBriefingsTable(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32)||(this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_graph_from ON graph_edges(from_type, from_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_graph_to ON graph_edges(to_type, to_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(33,new Date().toISOString()),c.debug("DB","Migration 33 applied: graph_edges table created"))}createTickLogTable(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(34)||(this.db.run(`
    ...
    `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString()),c.debug("DB","Migration 34 applied: tick_log table created"))}insertTickLog(e){this.db.prepare(`
...
`):null}function jt(r,e,t,s){let n=[];n.push(...Ge(r));let i="";for(let o of e)if(o.type==="summary"){let a=o.data,d=_e(a.displayTime);n.push(...Ye(a,d))}else{let a=o.data,d=ue(a.created_at),E=d!==i?d:"";if(i=d,t.has(a.id)){let l=pt(a,s);n.push(...We(a,E,l,s))}else n.push(Be(a,E,s))}return n}function Bt(r,e,t,s,n){let i=[];i.push(...st(r));let o=null,a="";for(let d of e)if(d.type==="summary"){o=null,a="";let u=d.data,E=_e(u.displayTime);i.push(...ot(u,E))}else{let u=d.data,E=mt(u.files_modified,n,u.files_read),p=ue(u.created_at),l=p!==a;a=p;let g=t.has(u.id);if(E!==o&&(i.push(...rt(E)),o=E),g){let b=pt(u,s);i.push(...it(u,p,l,b,s))}else i.push(nt(u,p,l,s))}return i.push(""),i}function Wt(r,e,t,s,n,i){return i?Bt(r,e,t,s,n):jt(r,e,t,s)}function lt(r,e,t,s,n){let i=[],o=Gt(r);for(let[a,d]of o)i.push(...Wt(a,d,e,t,s,n));return i}function Tt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function gt(r,e){let t=[];return e?(t.push(...F("Investigated",r.investigated,_.blue)),t.push(...F("Learned",r.learned,_.yellow)),t.push(...F("Completed",r.completed,_.green)),t.push(...F("Next Steps",r.next_steps,_.magenta))):(t.push(...k("Investigated",r.investigated)),t.push(...k("Learned",r.learned)),t.push(...k("Completed",r.completed)),t.push(...k("Next Steps",r.next_steps))),t}function ft(r,e){return e?at(r):qe(r)}function St(r,e,t){return!B(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?dt(r.totalDiscoveryTokens,r.totalReadTokens):Ve(r.totalDiscoveryTokens,r.totalReadTokens)}var Yt=bt.default.join((0,ht.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function qt(){try{return new H}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,At.unlinkSync)(Yt)}catch(e){c.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return c.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Vt(r,e){return e?_t(r):Ke(r)}function Kt(r,e,t,s,n,i,o){let a=[],d=re(e);a.push(...ut(r,d,s,o));let u=t.slice(0,s.sessionCount),E=xe(u,t),p=ae(e,E),l=ke(e,s.fullObservationCount);a.push(...lt(p,l,s,n,o));let g=t[0],b=e[0];Tt(s,g,b)&&a.push(...gt(g,o));let O=oe(e,s,i,n);return a.push(...ft(O,o)),a.push(...St(d,s,o)),a.join(`
`).trimEnd()}async function ce(r,e=!1){let t=ee(),s=r?.cwd??process.cwd(),n=Ie(s),i=r?.platform_source,o=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=qt();if(!a)return"";try{let d=o.length>1?ve(a,o,t,i):ne(a,n,t,i),u=o.length>1?Ue(a,o,t,i):ie(a,n,t,i);return d.length===0&&u.length===0?Vt(n,e):Kt(n,d,u,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
