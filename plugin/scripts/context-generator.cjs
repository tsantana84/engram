"use strict";var Ot=Object.create;var w=Object.defineProperty;var It=Object.getOwnPropertyDescriptor;var Lt=Object.getOwnPropertyNames;var Ct=Object.getPrototypeOf,Dt=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},me=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Lt(e))!Dt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=It(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?Ot(Ct(r)):{},me(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),Mt=r=>me(w({},"__esModule",{value:!0}),r);var ss={};yt(ss,{generateContext:()=>ce});module.exports=Mt(ss);var ht=y(require("path"),1),Nt=require("os"),At=require("fs");var Ne=require("bun:sqlite"),Ae=require("child_process");var S=require("path"),Q=require("os"),$=require("fs");var Te=require("url");var L=require("fs"),M=require("path"),le=require("os"),K=(i=>(i[i.DEBUG=0]="DEBUG",i[i.INFO=1]="INFO",i[i.WARN=2]="WARN",i[i.ERROR=3]="ERROR",i[i.SILENT=4]="SILENT",i))(K||{}),pe=(0,M.join)((0,le.homedir)(),".engram"),J=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;sinks=[];constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,M.join)(pe,"logs");(0,L.existsSync)(e)||(0,L.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,M.join)(e,`engram-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,M.join)(pe,"settings.json");if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=K[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(i,null,2):E=" "+this.formatData(i));let p="";if(n){let{sessionId:g,memorySessionId:b,correlationId:R,...m}=n;Object.keys(m).length>0&&(p=` {${Object.entries(m).map(([T,f])=>`${T}=${f}`).join(", ")}}`)}let l=`[${o}] [${a}] [${d}] ${c}${s}${p}${E}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,l+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),E=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",p={...s,location:E};return this.warn(e,`[HAPPY-PATH] ${t}`,p,n),i}},u=new J;var kt={};function vt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Te.fileURLToPath)(kt.url))}var Ut=vt();function xt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,Q.homedir)(),".engram"),e=(0,S.join)(r,"settings.json");try{if((0,$.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=xt(),C=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,Q.homedir)(),".claude"),as=(0,S.join)(C,"plugins","marketplaces","thedotmack"),ds=(0,S.join)(O,"archives"),_s=(0,S.join)(O,"logs"),us=(0,S.join)(O,"trash"),cs=(0,S.join)(O,"backups"),Es=(0,S.join)(O,"modes"),ms=(0,S.join)(O,"settings.json"),ge=(0,S.join)(O,"claude-mem.db"),ps=(0,S.join)(O,"vector-db"),ls=(0,S.join)(O,"observer-sessions"),Ts=(0,S.join)(C,"settings.json"),gs=(0,S.join)(C,"commands"),Ss=(0,S.join)(C,"CLAUDE.md");function Se(r){(0,$.mkdirSync)(r,{recursive:!0})}function fe(){return(0,S.join)(Ut,"..")}var be=require("crypto");var Ft=3e4;function P(r,e,t){return(0,be.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function X(r,e,t){let s=t-Ft;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function wt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function D(r){if(!r)return h;let e=wt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function he(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),i=e.indexOf(s);return n!==-1||i!==-1?n===-1?1:i===-1?-1:n-i:t.localeCompare(s)})}function $t(r,e){return{customTitle:r,platformSource:e?D(e):void 0}}var H=class{db;syncQueue=null;setSyncQueue(e){this.syncQueue=e}constructor(e=ge){e!==":memory:"&&Se(O),this.db=new Ne.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.createSyncQueueTable(),this.addProvenanceColumns(),this.addExtractionStatusColumns(),this.widenSyncQueueForLearnings(),this.addLastErrorColumn(),this.createSessionBriefingsTable(),this.createGraphEdgesTable(),this.createTickLogTable(),this.createCorrectionsTable()}initializeSchema(){this.db.run(`
    ...
    `).get(e).count}createSDKSession(e,t,s,n,i){let o=new Date,a=o.getTime(),d=$t(n,i),c=d.platformSource??h,E=this.db.prepare(`
    ...
    `).run(e)}storeSummary(e,t,s,n,i=0,o){let a=o??Date.now(),d=new Date(a).toISOString(),E=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,i,d,a),p=Number(E.lastInsertRowid);return this.syncQueue?.enqueue("summary",p),{id:p,createdAtEpoch:a}}storeObservations(e,t,s,n,i,o=0,a,d){let c=a??Date.now(),E=new Date(c).toISOString(),l=this.db.transaction(()=>{let g=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let m of s){let N=P(e,m.title,m.narrative),T=X(this.db,N,c);if(T){g.push(T.id);continue}let f=b.run(e,t,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),i||null,o,N,E,c,d||null);g.push(Number(f.lastInsertRowid))}let R=null;if(n){let N=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,i||null,o,E,c);R=Number(N.lastInsertRowid)}return{observationIds:g,summaryId:R,createdAtEpoch:c}})();for(let g of l.observationIds)this.syncQueue?.enqueue("observation",g);return l.summaryId!==null&&this.syncQueue?.enqueue("summary",l.summaryId),l}storeObservationsAndMarkComplete(e,t,s,n,i,o,a,d=0,c,E){let p=c??Date.now(),l=new Date(p).toISOString();return this.db.transaction(()=>{let b=[],R=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let f=P(e,T.title,T.narrative),Ee=X(this.db,f,p);if(Ee){b.push(Ee.id);continue}let Rt=R.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),a||null,d,f,l,p,E||null);b.push(Number(Rt.lastInsertRowid))}let m;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,l,p);m=Number(f.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(p,i),{observationIds:b,summaryId:m,createdAtEpoch:p}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:i}=t,o=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),c=[...e],E=i?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return i&&c.push(i),this.db.prepare(`
    ...
    `).all(...c)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,i){let o=i?"AND project = ?":"",a=i?[i]:[],d,c;if(e!==null){let m=`
      ...
      `,N=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let T=this.db.prepare(m).all(e,...a,s+1),f=this.db.prepare(N).all(e,...a,n+1);if(T.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,c=f.length>0?f[f.length-1].created_at_epoch:t}catch(T){return u.error("DB","Error getting boundary observations",void 0,{error:T,project:i}),{observations:[],sessions:[],prompts:[]}}}else{let m=`
      ...
      `,N=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let T=this.db.prepare(m).all(t,...a,s),f=this.db.prepare(N).all(t,...a,n+1);if(T.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,c=f.length>0?f[f.length-1].created_at_epoch:t}catch(T){return u.error("DB","Error getting boundary timestamps",void 0,{error:T,project:i}),{observations:[],sessions:[],prompts:[]}}}let E=`
      SELECT *
      FROM observations
...
`}function ut(r,e,t,s){let n=[];return s?n.push(...Qe(r)):n.push(...we(r)),s?n.push(...ze()):n.push(...$e()),s?n.push(...Ze()):n.push(...Pe()),s?n.push(...et()):n.push(...Xe()),B(t)&&(s?n.push(...tt(e,t)):n.push(...He(e,t))),n}var de=y(require("path"),1);function V(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function _e(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ue(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Et(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ct(r,e){return de.default.isAbsolute(r)?de.default.relative(e,r):r}function mt(r,e,t){let s=V(r);if(s.length>0)return ct(s[0],e);if(t){let n=V(t);if(n.length>0)return ct(n[0],e)}return"General"}function jt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,i=Et(n);e.has(i)||e.set(i,[]),e.get(i).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let i=new Date(s[0]).getTime(),o=new Date(n[0]).getTime();return i-o});return new Map(t)}function pt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?V(r.facts).join(`
`):null}function Bt(r,e,t,s){let n=[];n.push(...Ge(r));let i="";for(let o of e)if(o.type==="summary"){let a=o.data,d=_e(a.displayTime);n.push(...Ye(a,d))}else{let a=o.data,d=ue(a.created_at),E=d!==i?d:"";if(i=d,t.has(a.id)){let l=pt(a,s);n.push(...We(a,E,l,s))}else n.push(Be(a,E,s))}return n}function Wt(r,e,t,s,n){let i=[];i.push(...st(r));let o=null,a="";for(let d of e)if(d.type==="summary"){o=null,a="";let c=d.data,E=_e(c.displayTime);i.push(...ot(c,E))}else{let c=d.data,E=mt(c.files_modified,n,c.files_read),p=ue(c.created_at),l=p!==a;a=p;let g=t.has(c.id);if(E!==o&&(i.push(...rt(E)),o=E),g){let b=pt(c,s);i.push(...it(c,p,l,b,s))}else i.push(nt(c,p,l,s))}return i.push(""),i}function Yt(r,e,t,s,n,i){return i?Wt(r,e,t,s,n):Bt(r,e,t,s)}function lt(r,e,t,s,n){let i=[],o=jt(r);for(let[a,d]of o)i.push(...Yt(a,d,e,t,s,n));return i}function Tt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function gt(r,e){let t=[];return e?(t.push(...F("Investigated",r.investigated,_.blue)),t.push(...F("Learned",r.learned,_.yellow)),t.push(...F("Completed",r.completed,_.green)),t.push(...F("Next Steps",r.next_steps,_.magenta))):(t.push(...k("Investigated",r.investigated)),t.push(...k("Learned",r.learned)),t.push(...k("Completed",r.completed)),t.push(...k("Next Steps",r.next_steps))),t}function St(r,e){return e?at(r):qe(r)}function ft(r,e,t){return!B(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?dt(r.totalDiscoveryTokens,r.totalReadTokens):Ve(r.totalDiscoveryTokens,r.totalReadTokens)}var qt=2e3;function Vt(r,e){try{return r.db.prepare(`
      SELECT next_steps, completed FROM session_summaries
      WHERE project = ? ORDER BY created_at_epoch DESC LIMIT 1
    `).get(e)}catch{return null}}function Kt(r,e){try{return r.db.prepare(`
      SELECT tried, wrong_because, fix, trigger_context FROM corrections
      WHERE project = ? AND trigger_context != ''
      ORDER BY created_at DESC LIMIT 3
    `).all(e)}catch{return[]}}function Jt(r,e){try{return r.db.prepare(`
      SELECT title, narrative FROM observations
      WHERE project = ? AND type = 'decision'
      ORDER BY created_at_epoch DESC LIMIT 5
    `).all(e)}catch{return[]}}function Qt(r,e,t){let s=["## AGENT BRIEFING"];if(r?.next_steps||r?.completed){let n=[];r.completed&&n.push(`Completed: ${r.completed}`),r.next_steps&&n.push(`Next: ${r.next_steps}`),s.push(`**Last session:** ${n.join(". ")}`)}if(e.length>0){let n=e.map(i=>`- Tried: ${i.tried}. Wrong because: ${i.wrong_because}. Fix: ${i.fix}. [Context: ${i.trigger_context}]`);s.push(`**Watch out:**
${n.join(`
`)}`)}if(t.length>0){let n=t.map(i=>`- ${i.title??i.narrative??""}`.slice(0,120));s.push(`**Decisions made:**
${n.join(`
`)}`)}return s.length===1?"":(s.push("---"),s.join(`

`))}function bt(r,e){let t=Vt(r,e),s=Kt(r,e),n=Jt(r,e);return Qt(t,s,n).slice(0,qt)}var zt=ht.default.join((0,Nt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Zt(){try{return new H}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,At.unlinkSync)(zt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function es(r,e){return e?_t(r):Ke(r)}function ts(r,e,t,s,n,i,o){let a=[],d=re(e);a.push(...ut(r,d,s,o));let c=t.slice(0,s.sessionCount),E=xe(c,t),p=ae(e,E),l=ke(e,s.fullObservationCount);a.push(...lt(p,l,s,n,o));let g=t[0],b=e[0];Tt(s,g,b)&&a.push(...gt(g,o));let R=oe(e,s,i,n);return a.push(...St(R,o)),a.push(...ft(d,s,o)),a.join(`
`).trimEnd()}async function ce(r,e=!1){let t=ee(),s=r?.cwd??process.cwd(),n=Ie(s),i=r?.platform_source,o=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Zt();if(!a)return"";try{let d=bt(a,n),c=o.length>1?ve(a,o,t,i):ne(a,n,t,i),E=o.length>1?Ue(a,o,t,i):ie(a,n,t,i);if(c.length===0&&E.length===0)return es(n,e);let p=ts(n,c,E,t,s,r?.session_id,e);return d?d+`

`+p:p}finally{a.close()}}0&&(module.exports={generateContext});
