"use strict";var Rt=Object.create;var F=Object.defineProperty;var Nt=Object.getOwnPropertyDescriptor;var Ct=Object.getOwnPropertyNames;var It=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var yt=(r,e)=>{for(var t in e)F(r,t,{get:e[t],enumerable:!0})},pe=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ct(e))!Lt.call(r,n)&&n!==t&&F(r,n,{get:()=>e[n],enumerable:!(s=Nt(e,n))||s.enumerable});return r};var v=(r,e,t)=>(t=r!=null?Rt(It(r)):{},pe(e||!r||!r.__esModule?F(t,"default",{value:r,enumerable:!0}):t,r)),vt=r=>pe(F({},"__esModule",{value:!0}),r);var Jt={};yt(Jt,{generateContext:()=>ce});module.exports=vt(Jt);var bt=v(require("path"),1),ht=require("os"),At=require("fs");var Ae=require("bun:sqlite"),Oe=require("child_process");var f=require("path"),Q=require("os"),w=require("fs");var Te=require("url");var I=require("fs"),M=require("path"),Ee=require("os"),K=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(K||{}),le=(0,M.join)((0,Ee.homedir)(),".engram"),J=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,M.join)(le,"logs");(0,I.existsSync)(e)||(0,I.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,M.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,M.join)(le,"settings.json");if((0,I.existsSync)(e)){let t=(0,I.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=K[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let l="";if(n){let{sessionId:g,memorySessionId:b,correlationId:R,...p}=n;Object.keys(p).length>0&&(l=` {${Object.entries(p).map(([T,S])=>`${T}=${S}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${_}${s}${l}${m}`;if(this.logFilePath)try{(0,I.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},c=new J;var xt={};function Mt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Te.fileURLToPath)(xt.url))}var Dt=Mt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,Q.homedir)(),".engram"),e=(0,f.join)(r,"settings.json");try{if((0,w.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=Ut(),L=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,Q.homedir)(),".claude"),ts=(0,f.join)(L,"plugins","marketplaces","thedotmack"),ss=(0,f.join)(N,"archives"),rs=(0,f.join)(N,"logs"),ns=(0,f.join)(N,"trash"),os=(0,f.join)(N,"backups"),is=(0,f.join)(N,"modes"),as=(0,f.join)(N,"settings.json"),ge=(0,f.join)(N,"claude-mem.db"),ds=(0,f.join)(N,"vector-db"),us=(0,f.join)(N,"observer-sessions"),_s=(0,f.join)(L,"settings.json"),cs=(0,f.join)(L,"commands"),ms=(0,f.join)(L,"CLAUDE.md");function fe(r){(0,w.mkdirSync)(r,{recursive:!0})}function Se(){return(0,f.join)(Dt,"..")}var be=require("crypto");var kt=3e4;function P(r,e,t){return(0,be.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function X(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function $t(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return h;let e=$t(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function he(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ft(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var H=class{db;syncQueue=null;setSyncQueue(e){this.syncQueue=e}constructor(e=ge){e!==":memory:"&&fe(N),this.db=new Ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.createSyncQueueTable(),this.addProvenanceColumns()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,_=s==="date_asc"?"ASC":"DESC",m=n?`LIMIT ${n}`:"",l=e.map(()=>"?").join(","),E=[...e],g=[];if(o&&(g.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let p=i.map(()=>"?").join(",");g.push(`type IN (${p})`),E.push(...i)}else g.push("type = ?"),E.push(i);if(a){let p=Array.isArray(a)?a:[a],A=p.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...p),g.push(`(${A.join(" OR ")})`)}if(d){let p=Array.isArray(d)?d:[d],A=p.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");p.forEach(T=>{E.push(`%${T}%`,`%${T}%`)}),g.push(`(${A.join(" OR ")})`)}let b=g.length>0?`WHERE id IN (${l}) AND ${g.join(" AND ")}`:`WHERE id IN (${l})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),_=new Date(d).toISOString(),m=P(e,s.title,s.narrative),l=X(this.db,m,d);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let E=null;try{let p=(0,Oe.spawnSync)("git",["rev-parse","--abbrev-ref","HEAD"],{encoding:"utf8",timeout:2e3});p.status===0&&!p.error&&(E=p.stdout.trim()||null)}catch{}let b=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
       generated_by_model, git_branch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,m,_,d,a||null,E),R=Number(b.lastInsertRowid);return this.syncQueue?.enqueue("observation",R),{id:R,createdAtEpoch:d}}invalidateObservation(e,t){let s=Date.now();this.db.prepare(`
      UPDATE observations
    ...
    `).run(e)}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),m=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a),l=Number(m.lastInsertRowid);return this.syncQueue?.enqueue("summary",l),{id:l,createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),m=new Date(_).toISOString(),E=this.db.transaction(()=>{let g=[],b=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let p of s){let A=P(e,p.title,p.narrative),T=X(this.db,A,_);if(T){g.push(T.id);continue}let S=b.run(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),o||null,i,A,m,_,d||null);g.push(Number(S.lastInsertRowid))}let R=null;if(n){let A=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,_);R=Number(A.lastInsertRowid)}return{observationIds:g,summaryId:R,createdAtEpoch:_}})();for(let g of E.observationIds)this.syncQueue?.enqueue("observation",g);return E.summaryId!==null&&this.syncQueue?.enqueue("summary",E.summaryId),E}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,_,m){let l=_??Date.now(),E=new Date(l).toISOString();return this.db.transaction(()=>{let b=[],R=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let S=P(e,T.title,T.narrative),me=X(this.db,S,l);if(me){b.push(me.id);continue}let Ot=R.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),a||null,d,S,E,l,m||null);b.push(Number(Ot.lastInsertRowid))}let p;if(n){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,E,l);p=Number(S.lastInsertRowid)}return this.db.prepare(`
      ...
      `).run(l,o),{observationIds:b,summaryId:p,createdAtEpoch:l}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),_=[...e],m=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&_.push(o),this.db.prepare(`
    ...
    `).all(..._)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,_;if(e!==null){let p=`
      ...
      `,A=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let T=this.db.prepare(p).all(e,...a,s+1),S=this.db.prepare(A).all(e,...a,n+1);if(T.length===0&&S.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,_=S.length>0?S[S.length-1].created_at_epoch:t}catch(T){return c.error("DB","Error getting boundary observations",void 0,{error:T,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let p=`
      ...
      `,A=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let T=this.db.prepare(p).all(t,...a,s),S=this.db.prepare(A).all(t,...a,n+1);if(T.length===0&&S.length===0)return{observations:[],sessions:[],prompts:[]};d=T.length>0?T[T.length-1].created_at_epoch:t,_=S.length>0?S[S.length-1].created_at_epoch:t}catch(T){return c.error("DB","Error getting boundary timestamps",void 0,{error:T,project:o}),{observations:[],sessions:[],prompts:[]}}}let m=`
      SELECT *
      FROM observations
...
`}function _t(r,e,t,s){let n=[];return s?n.push(...Qe(r)):n.push(...Fe(r)),s?n.push(...ze()):n.push(...we()),s?n.push(...Ze()):n.push(...Pe()),s?n.push(...et()):n.push(...Xe()),B(t)&&(s?n.push(...tt(e,t)):n.push(...He(e,t))),n}var de=v(require("path"),1);function V(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return c.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ue(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function _e(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function mt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ct(r,e){return de.default.isAbsolute(r)?de.default.relative(e,r):r}function pt(r,e,t){let s=V(r);if(s.length>0)return ct(s[0],e);if(t){let n=V(t);if(n.length>0)return ct(n[0],e)}return"General"}function jt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=mt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?V(r.facts).join(`
`):null}function Gt(r,e,t,s){let n=[];n.push(...je(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=ue(a.displayTime);n.push(...Ye(a,d))}else{let a=i.data,d=_e(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let E=lt(a,s);n.push(...We(a,m,E,s))}else n.push(Be(a,m,s))}return n}function Bt(r,e,t,s,n){let o=[];o.push(...st(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=ue(_.displayTime);o.push(...it(_,m))}else{let _=d.data,m=pt(_.files_modified,n,_.files_read),l=_e(_.created_at),E=l!==a;a=l;let g=t.has(_.id);if(m!==i&&(o.push(...rt(m)),i=m),g){let b=lt(_,s);o.push(...ot(_,l,E,b,s))}else o.push(nt(_,l,E,s))}return o.push(""),o}function Wt(r,e,t,s,n,o){return o?Bt(r,e,t,s,n):Gt(r,e,t,s)}function Et(r,e,t,s,n){let o=[],i=jt(r);for(let[a,d]of i)o.push(...Wt(a,d,e,t,s,n));return o}function Tt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function gt(r,e){let t=[];return e?(t.push(...$("Investigated",r.investigated,u.blue)),t.push(...$("Learned",r.learned,u.yellow)),t.push(...$("Completed",r.completed,u.green)),t.push(...$("Next Steps",r.next_steps,u.magenta))):(t.push(...k("Investigated",r.investigated)),t.push(...k("Learned",r.learned)),t.push(...k("Completed",r.completed)),t.push(...k("Next Steps",r.next_steps))),t}function ft(r,e){return e?at(r):qe(r)}function St(r,e,t){return!B(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?dt(r.totalDiscoveryTokens,r.totalReadTokens):Ve(r.totalDiscoveryTokens,r.totalReadTokens)}var Yt=bt.default.join((0,ht.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function qt(){try{return new H}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,At.unlinkSync)(Yt)}catch(e){c.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return c.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Vt(r,e){return e?ut(r):Ke(r)}function Kt(r,e,t,s,n,o,i){let a=[],d=re(e);a.push(..._t(r,d,s,i));let _=t.slice(0,s.sessionCount),m=xe(_,t),l=ae(e,m),E=ke(e,s.fullObservationCount);a.push(...Et(l,E,s,n,i));let g=t[0],b=e[0];Tt(s,g,b)&&a.push(...gt(g,i));let R=ie(e,s,o,n);return a.push(...ft(R,i)),a.push(...St(d,s,i)),a.join(`
`).trimEnd()}async function ce(r,e=!1){let t=ee(),s=r?.cwd??process.cwd(),n=Ce(s),o=r?.platform_source,i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=qt();if(!a)return"";try{let d=i.length>1?De(a,i,t,o):ne(a,n,t,o),_=i.length>1?Ue(a,i,t,o):oe(a,n,t,o);return d.length===0&&_.length===0?Vt(n,e):Kt(n,d,_,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
